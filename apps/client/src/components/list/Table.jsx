...
export function Table({ facilities, sortField, sortDirection, onSort }) {
    return (
                            ...
                            <tr key={facility.id} className="border-b">
                                <td className="p-4 font-medium">
                                    <div className="flex items-center gap-2">
                                        <img
                                            src={`https://comp-analysis-xlky.onrender.com/api/markers?color=${facility.color.toString().slice(1)}`}
                                            alt="marker"
                                            className="w-8 h-10"
                                        />
